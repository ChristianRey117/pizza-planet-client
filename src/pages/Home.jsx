...
import heroImg from "../assets/images/pizza_home1.jpg";
...
import Promociones from "../components/UI/Promociones/Promociones.jsx";

const featureData = [
  {
    title: "Quick Delivery",
    imgUrl: featureImg01,
    desc: "Nuestros productos llegan en menos de 45 min",
  },
  {
    title: "Super Cena",
    imgUrl: featureImg02,
    desc: "Entregado en cohete record",
  },
  {
    title: "Facil Entrega",
    imgUrl: featureImg03,
    desc: "Nuestras entregas en sucursal o domicilio garantizadas",
  },
];
const Home = () => {
            ...
            <Col lg="6" md="6">
              <div className="why__foodie">
                <h2 className="foodie-title mb-4">
                  Por que <span>Pizza Planeta?</span>
                </h2>
                ...
                <ListGroup className="mt-4">
                  <ListGroupItem className="border-0 ps-0">
                    <p className="choose__us-title d-flex align-items-center gap-2">
                      <i className="ri-checkbox-circle-line"></i>Fresca y
                      deliciosa comida
                    </p>
                  </ListGroupItem>
                  <ListGroupItem className="border-0 ps-0">
                  ...
                  <ListGroupItem className="border-0 ps-0">
                    <p className="choose__us-title d-flex align-items-center gap-2">
                      <i className="ri-checkbox-circle-line"></i>Ordenes desde
          ...
          <Row>
            <Col lg="6" md="6">
              <div className="testimonial">
                <h5 className="testimonial__subtitle mb-4">Reseñas</h5>
