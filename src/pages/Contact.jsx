          ...
          <Row>
            <Col>
              <h5>
                ...
                experiencia gastronómica inolvidable. ¡Únete a nosotros en este
                viaje cósmico de sabor y disfruta de la pizza como nunca antes!
                <br />
                Atentamente, El Equipo de "Pizza Planeta"
              </h5>
            </Col>
          </Row>
        </Container>
